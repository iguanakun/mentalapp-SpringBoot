...
public class CbtCrConst {
  /** プレフィックス */
  public static final String PREFIX = "cbt_cr/";

  /** 新規作成画面のパス */
  public static final String NEW_PATH = "cbt_cr/new";

  /** 新規作成画面のパス */
  public static final String REDIRECT_NEW_PATH = "redirect:/cbt_cr/new";
  ...
  /** リダイレクト（IDを含む）のプレフィックス */
  public static final String REDIRECT_PREFIX = "redirect:/cbt_cr/";
